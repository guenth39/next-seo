      ...
      if (
        ...
        b.push(
          ...
          'profile' === d && a.openGraph.profile
            ...
            : 'product' === d && a.openGraph.product
            ? (a.openGraph.product.plural_title &&
                b.push(
                  _react['default'].createElement('meta', {
                    key: 'product:plural_title',
                    property: 'product:plural_title',
                    content: a.openGraph.product.plural_title,
                  }),
                ),
              a.openGraph.product.prices &&
                a.openGraph.product.prices.length &&
                a.openGraph.product.prices.forEach(function(a, c) {
                  a.amount &&
                    a.currency &&
                    (b.push(
                      _react['default'].createElement('meta', {
                        key: 'product:price:amount:0'.concat(c),
                    ...
                    b.push(
                      _react['default'].createElement('meta', {
                        key: 'product:price:currency:0'.concat(c),
